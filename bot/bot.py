...
async def check_membership(update: Update, context: CallbackContext):
    ...
    if (userMembership.status not in (ChatMemberStatus.MEMBER, ChatMemberStatus.OWNER)): 
        text = "Go away, you are not {} subscriber".format(config.allowed_channel)
...
async def start_handle(update: Update, context: CallbackContext):
    ...
    reply_text = "Hi! I'm <b>ChatGPT</b> bot implemented for {} subscribers 🤖\n\n".format(config.allowed_channel)
...
def run_bot() -> None:
    ...
    # user_filter = filters.
    # user_filter = user_filter = filters.User(user_id )
    # if (user_id and getChatMember(config.allowed_channel, user_id)):
    #     print('user exist')
